...
length(unique(site_table$Species_percent_sim)) # 106 taxa
...
str(site_RelAbund_LLLM_wide) # 31 levels (sites) of response variable LLLM x 106 predictor variables taxonomic labels
...
fish_2019_LLLM_random_forest_top_taxa_all <- fish_2019_LLLM_random_forest_top_taxa_all %>% mutate(Species_percent_sim = recode(Species_percent_sim, "actinopteri_0_80" = "Actinopteri 0.80", 
                                 "atherinops_affinis_0_99" = "Atherinops affinis 0.99",
                                "embiotocidae_0_95" = "Embiotocidae 0.95",
                                 "embiotocidae_0_97" = "Embiotocidae 0.97",
                                "leptocottus_armatus_0_99" = "Leptocottus armatus 0.99",
                                "pholis_0_99" = "Pholis 0.99",
                                "pholis_ornata_0_99" = "Pholis ornata 0.99",
                                "syngnathus_0_99" = "Syngnathus 0.99",
                                "clupea_pallasii_0_99" = "clupea pallasii 0.99",
                                "engraulis_mordax_0_99" = "Engraulis mordax 0.99"
                                ))
...
embiotocidae_0_95 <- subset_table_LLLM_top_taxa[[4]]
embiotocidae_0_97 <- subset_table_LLLM_top_taxa[[5]]
engraulis_mordax_0_99 <- subset_table_LLLM_top_taxa[[6]]
leptocottus_armatus_0_99 <- subset_table_LLLM_top_taxa[[7]]
pholis_0_99 <- subset_table_LLLM_top_taxa[[8]]
pholis_ornata_0_99 <- subset_table_LLLM_top_taxa[[9]]
syngnathus_0_99 <- subset_table_LLLM_top_taxa[[10]]
...
# syngnathus_0_99
syngnathus_0_99_lme <- lme(Abundance_spp_sim ~ longest_blade_length_mean, random = ~1 | Region, method = "REML", data = syngnathus_0_99)
syngnathus_0_99_lme_summary <- summary(syngnathus_0_99_lme)
capture.output(syngnathus_0_99_lme_summary, file = "output/stats/syngnathus_0_99_lme_summary_LLLM.txt")

# create the prediction data frame
pred_overall <- ggpredict(syngnathus_0_99_lme, terms = c("longest_blade_length_mean"))  # this gives overall predictions for the model

# plot the overall predictions 
syngnathus_99_plot_overall <- ggplot(pred_overall) + 
   geom_line(aes(x = x, y = predicted)) +          
   geom_ribbon(aes(x = x, ymin = predicted - std.error, ymax = predicted + std.error), 
               fill = "gray28", alpha = 0.5) +  
   geom_point(data = syngnathus_0_99,
   ...
   labs(x = "Longest leaf length mean (mm)", y = "", title = "Syngnathus 0.99")  

syngnathus_99_plot_overall
ggsave(syngnathus_99_plot_overall, file = "output/plots/syngnathus_99_plot_overall_prediction_LLLM.png", dpi = 400, device = "png", width = 12, height = 8, units = "in")

# plot relationship with shoot density and test with cor.test
plot(syngnathus_0_99$DensityShootsMean, syngnathus_0_99$Abundance_spp_sim)
syngnathus_0_99_rel_abund_cortest_density <- cor.test(syngnathus_0_99$DensityShootsMean, syngnathus_0_99$Abundance_spp_sim)
capture.output(syngnathus_0_99_rel_abund_cortest_density, file = "output/stats/syngnathus_0_99_rel_abund_cortest_density.txt")

syngnathus_99_plot_shoot_density <- ggplot(syngnathus_0_99, aes(x = DensityShootsMean, y = Abundance_spp_sim)) + 
   geom_point(aes(shape = Region), alpha = 0.5, size = 6, color = gr) + 
   geom_smooth(data = syngnathus_0_99, formula = y ~ x, method = "lm", color = gr) + 
   scale_shape_manual(values=c(8, 15, 3, 17, 18, 16)) +
   theme_classic() +
   theme(text = element_text(size=16), plot.title = element_text(size = 16, hjust = 0.5)) +
   labs(x = "Shoot density per m^2", y = "", title = "Syngnathus 0.99")  

syngnathus_99_plot_shoot_density
...
# embiotocidae 95
embiotocidae_0_95_lme <- lme(Abundance_spp_sim ~ longest_blade_length_mean, random = ~1 | Region, method = "REML", data = embiotocidae_0_95)
summary(embiotocidae_0_95_lme) 
embiotocidae_0_95_lme_summary <- summary(embiotocidae_0_95_lme)
capture.output(embiotocidae_0_95_lme_summary, file = "output/stats/embiotocidae_0_95_lme_summary_LLLM.txt")

# create the prediction data frame
pred_overall <- ggpredict(embiotocidae_0_95_lme, terms = c("longest_blade_length_mean"))  # this gives overall predictions for the model

# plot the overall predictions 
embiotocidae_0_95_plot_overall_no_legend <- ggplot(pred_overall) + 
   geom_line(aes(x = x, y = predicted)) +         
   geom_ribbon(aes(x = x, ymin = predicted - std.error, ymax = predicted + std.error), 
               fill = "gray28", alpha = 0.5) +
   geom_point(data = embiotocidae_0_95,
              aes(x = longest_blade_length_mean, y = Abundance_spp_sim, shape = 
                    Region), alpha = 0.5, size = 6, color = gr) + 
   scale_shape_manual(values=c(8, 15, 3, 17, 18, 16)) +
   theme_classic() +
   theme(text = element_text(size=16), plot.title = element_text(size = 16, hjust = 0.5), legend.position = "none") +
   labs(x = "", y = "", title = "Embiotocidae 0.95")  

embiotocidae_0_95_plot_overall_no_legend
ggsave(embiotocidae_0_95_plot_overall_no_legend, file = "output/plots/embiotocidae_0_95_plot_overall_prediction_LLLM_no_legend.png", dpi = 400, device = "png", width = 12, height = 8, units = "in")

# check relationship with shoot density 
embiotocidae_0_95_rel_abund_cortest_density <- cor.test(embiotocidae_0_95$DensityShootsMean, embiotocidae_0_95$Abundance_spp_sim)
capture.output(embiotocidae_0_95_rel_abund_cortest_density, file = "output/stats/embiotocidae_0_95_rel_abund_cortest_density")
...
# create the prediction data frame
pred_overall <- ggpredict(embiotocidae_0_97_lme, terms = c("longest_blade_length_mean"))  # this gives overall predictions for the model

# plot the overall predictions 
embiotocidae_0_97_plot_overall_no_legend <- ggplot(pred_overall) + 
   geom_line(aes(x = x, y = predicted)) +          
   geom_ribbon(aes(x = x, ymin = predicted - std.error, ymax = predicted + std.error), 
               fill = "gray28", alpha = 0.5) +  
   geom_point(data = embiotocidae_0_97,
              aes(x = longest_blade_length_mean, y = Abundance_spp_sim, shape = 
                    Region), alpha = 0.5, size = 6, color = gr) + 
   scale_shape_manual(values=c(8, 15, 3, 17, 18, 16)) +
   theme_classic() +
   theme(text = element_text(size=16), plot.title = element_text(size = 16, hjust = 0.5), legend.position = "none") +
   labs(x = "Longest leaf length mean (mm)", y = "", title = "Embiotocidae 0.97")  

embiotocidae_0_97_plot_overall_no_legend
ggsave(embiotocidae_0_97_plot_overall_no_legend, file = "output/plots/embiotocidae_0_97_plot_overall_prediction_LLLM_no_legend.png", dpi = 400, device = "png", width = 12, height = 8, units = "in")

# check relationship with shoot density 
embiotocidae_0_97_rel_abund_cortest_density <- cor.test(embiotocidae_0_97$DensityShootsMean, embiotocidae_0_97$Abundance_spp_sim)
capture.output(embiotocidae_0_97_rel_abund_cortest_density, file = "output/stats/embiotocidae_0_97_rel_abund_cortest_density.txt")
...
t <- tuneRF(train_region_red[1:106], train_region_red$Region,
       ...
       improve = 0.01)
# mtry of 25 
rf_region_mtry_25 <- randomForest(Region~., data=train_region_red, proximity=TRUE, importance = TRUE, mtry=25) # error rate is 24%; so model accuracy is 76%
...
set.seed(10)
rf_region <- randomForest(Region~., data=train_region_red, proximity=TRUE, importance = TRUE, mtry=25) # the OOB estimate of error rate is 28%; so model accuracy is 72%
rf_region_confusion = rf_region$confusion

region_pred <- predict(rf_region, test_region)
confusionMatrix(region_pred, test_region$Region) # 83% accuracy on test data p<0.001
...
# rename levels
Region_importance <- Region_importance %>% mutate(Species_percent_sim = recode(Species_percent_sim, 
                                "actinopteri_0_80" = "Actinopteri 0.80", 
                                "atherinops_affinis_0_99" = "Atherinops affinis 0.99",
                                "embiotocidae_0_90" = "Embiotocidae 0.90",
                                "leptocottus_armatus_0_99" = "Leptocottus armatus 0.99",
                                "pholis_0_99" = "Pholis 0.99",
                                "pholis_ornata_0_99" = "Pholis ornata 0.99",
                                "clupea_harengus_0_99" = "Clupea harengus 0.99",
                                "gasterosteus_aculeatus_0_99" = "Gasterosteus aculeatus 0.99",
                                "gymnogobius_macrognathos_0_90" = "Gymnogobius macrognathos 0.90",
                                "anisotremus_scapularis_0_97" = "Anisotremus scapularis 0.97",
                                "ammodytes_0_99" = "Ammodytes 0.99",
                                "atherinopsis_californiensis_0_99" = "Atherinopsis californiensis 0.99"
                                ))
...
BB_2019_species_list <- data.frame(unique(BB_2019_df$Species_percent_sim)) # 38 unique taxonomic ids (name and % sim value combined)
# rename column
...
AK_2019_species_list <- data.frame(unique(AK_2019_df$Species_percent_sim)) # 38 taxonomic ids (name and % sim value combined)
# rename column
...
BC_2019_species_list <- data.frame(unique(BC_2019_df$Species_percent_sim)) # 44 unique taxonomic ids (name and % sim value combined)
# rename column
...
WA_2019_species_list <- data.frame(unique(WA_2019_df$Species_percent_sim)) # 44 unique taxonomic ids (name and % sim value combined)
# rename column
...
OR_2019_species_list <- data.frame(unique(OR_2019_df$Species_percent_sim)) # 34 unique taxonomic ids (name and % sim value combined)
# rename column
...
SD_2019_species_list <- data.frame(unique(SD_2019_df$Species_percent_sim)) # 29 unique taxonomic ids (name and % sim value combined)
# rename column
...
BB_2020_species_list <- data.frame(unique(BB_2020_df$Species_percent_sim)) # 58 unique taxonomic ids (name and % sim value combined)
# rename column
...
BB_2019_2020_species_list <- bind_rows(BB_2019_species_list, BB_2020_species_list) # 96
# get unique list of species percent similarity
BB_2019_2020_species_list_unique <- unique(BB_2019_2020_species_list$Species_per_sim_list) # 61
...
df_19_BB <- df_19 %>% filter(RegionName == "Bodega")

BB_2019_eDNA_fish_species_per_sim <- unique(df_19_BB$Species_percent_sim)
BB_2019_eDNA_fish_taxon <- unique(df_19_BB$Species)

common_species_BB_2019 <- intersect(BB_2019_eDNA_fish_taxon, BB_2019_seine_fish_species)
eDNA_unique_species <- setdiff(BB_2019_eDNA_fish_taxon, BB_2019_seine_fish_species)
# remove families and orders for which species level ids are found in the seine data
eDNA_unique_species_reduced <- eDNA_unique_species[-which(eDNA_unique_species %in% c('Embiotocidae','Syngnathus','Stichaeidae', 'Pholis', 'Sebastes', 'Pleuronectidae', 'Actinopteri', 'Perciformes',  "Gobiidae"))] 
eDNA_unique_species_reduced
seine_unique_species <- setdiff(BB_2019_seine_fish_species, BB_2019_eDNA_fish_taxon)
